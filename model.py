...
class JERS(nn.Module):
    ...
    def forward(self, ref, mov, ref_am, if_train):
        ...
        striped_list, mask_list, warped_list, theta_list, theta_list_inv, am_mov_pred, am_ref_2_mov
        return striped_list, mask_list, warped_list, theta_list, theta_list_inv, am_mov_pred, am_ref_2_mov
